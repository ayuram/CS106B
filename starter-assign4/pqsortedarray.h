...
private:
    ...
    /*
     * This function expands allocated memory by 2 times its current amount.
     */
    void expand();

    /*
     * This function takes one argument 'toFill' and shifts every element starting from the right side of the index.
     * It also fills the needed index with the DataPoint
     */
    void moveOneUpFromIndex(DataPoint toFill);
